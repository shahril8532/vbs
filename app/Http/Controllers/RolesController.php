...
class RolesController extends Controller
{
    ...
    private function getRoles()
    {
        ...
        //$data = Role::withCount(['users', 'permissions'])->query(); 
        return DataTables::of($data)
                ...
                ->addColumn('action', function($row){
                    $action = ""; 
                    $action.="<a class='btn btn-xs btn-success' id='btnShow' title='Info' href='".route('users.roles.show', $row->id)."'><i class='fas fa-eye'></i></a> "; 
                    $action.="<a class='btn btn-xs btn-warning' id='btnEdit' title='Kemaskini' href='".route('users.roles.edit', $row->id)."'><i class='fas fa-edit'></i></a>"; 
